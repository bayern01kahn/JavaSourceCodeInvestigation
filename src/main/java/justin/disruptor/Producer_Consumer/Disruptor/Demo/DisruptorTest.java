package justin.disruptor.Producer_Consumer.Disruptor.Demo;
...
public class DisruptorTest {
    ...
    public static void main(String[] args) {
        String message = "Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!Hello Disruptor!";
