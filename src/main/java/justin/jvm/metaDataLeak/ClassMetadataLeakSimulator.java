package justin.jvm.metaDataLeak;
...
/**
 * 
 * 这个类是不断通过反射来设置创造元数据，在没有对堆栈内存限制的情况下，是可以自动扩充的。
 * 可以看出，Metaspace进行了动态扩展，本地内存达到了300多M，加载超过5万个类后还没有出现OOM事件。
 * 
 * -Xmx2g -Xms2g -Xmn1g -XX:+PrintGCDetails -XX:MaxMetaspaceSize=32m
 * 
