...
public class DateUtil {
	...
	public final static String NAMED_DATE_TIME = "yyyyMMddHHmmss";
	...
	public static String formatNamedDate(Date date) {
		DateTime dateTime = new DateTime(date);
		return DateTimeFormat.forPattern(NAMED_DATE_TIME).print(dateTime);
	}
