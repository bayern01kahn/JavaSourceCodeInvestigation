...
public class JHandlerAdapter {
    ...
    JModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        JHandlerMapping handlerMapping = (JHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == JModelAndView.class;
        if(isModelAndView){
            return (JModelAndView) result;
        }
        return null;
    }
